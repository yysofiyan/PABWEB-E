...
<head>
	...
	<meta name="author" content="Indra Stywantoro">
...
<div class="container-fluid">
	<div class="d-flex-colomn flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
		<h5 class="my-0 mr-md-auto font-weight-normal"><i class="fas-user title-icon"></i>
		Siswa </h5>
	</div>
</div>
...
<!-- datepicker js-->
<script type="text/javascript" src="assets/plugins/datepicker/js/bootstrap-datepicker.min"></script>
...
(function(){
	...
	//fetch all the fprm we want to apply custom bootstrap validation styles to	
...
//validasi image dan preview sebelum upload
	function validasiFile (){
		...
		//jika tipe file yang diupload tidak sesuai dengan allowed Extensions, tampilkan pesan
		if(!allowedExtension.exec(filePath)){
			alert('Tipe file foto tidak sesuai. Harap unggah file foto yang memiliki tipe *.jpg,*.jpeg,*.png');
			fileInput.value = '';
			document.getElementById('imagePreview').innerHTML = '<img class="foto-preview" src="foto/default.png/>';
			return false;
		}
		//jika ukuran file yang diupload lebih sama dengan 1mb
		else if (fileSize>=1000000){
			alert('Ukuran file foto lebih dari 1Mb. Harap unggah file foto yang memiliki ukuran maksimal 1Mb.');
			fileInput.value=''
			document.getElementById(imagePreview).innerHTML = '<img class="foto-preview" src="foto/default.png"/>'
			return false;
		}
		// selain itu
			...
			//image preview
		if (filePath.files && fileInput.files[0]) {
			var reader = new FileReader ();
			reader.onload = function(e) {
				document.getElementById('imagePreview').innerHTML = '<img class="foto-preview" src="'+e.target.resukt+'"/>';
			};
